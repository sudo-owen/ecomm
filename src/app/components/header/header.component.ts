...
@Component({
  ...
  template: `
    <header class="px-4 lg:px-6 h-14 flex items-center align-left space-x-4">
      ...
      <svg class ="h-8 w-8" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60" xml:space="preserve">
      ...
      <nav class="flex gap-4 sm:gap-6">
        <a class="text-sm font-medium hover:underline underline-offset-4" routerLink="/products">Products</a>
      </nav>
    </header>
  `
})
